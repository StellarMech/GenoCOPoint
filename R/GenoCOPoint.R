...
#' geno_file <- "examples/genofiles/AAACGCTGTGATATAG_smt_genotypes_withname_reads.txt"
#' truth_file <- "examples/truthfiles/AAACGCTGTGATATAG_allele_cnts_at_markers_sorted_co_pred.txt"
#' # Run the function
